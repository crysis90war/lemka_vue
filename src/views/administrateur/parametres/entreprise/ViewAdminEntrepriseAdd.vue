      ...
      <b-card-body>
        <b-form @submit.prevent="submit">
          <b-row>
            <b-col lg="6">
              <b-form-group id="intput-groupe-societe" label="Nom de société"
                ...
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.nom_societe.required">Ce champ est obligatoire.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.nom_societe.minLength">Ce champ doit contenir au moins 2 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.nom_societe.maxLength">Ce champ doit contenir au moins 255 caractères.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
            ...
            <b-col lg="6">
              <b-form-group id="intput-groupe-tva" label="Numéro de TVA"
                ...
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tva.required">Ce champ est obligatoire.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tva.minLength">Ce champ doit contenir au moins 2 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tva.maxLength">Ce champ doit contenir au moins 255 caractères.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
          </b-row>
          ...
          <b-row>
            <b-col lg="4">
              <b-form-group id="intput-groupe-mail" label="Email" description="Veuillez encoder l'email de la société"
                ...
                <b-form-input v-model="$v.entreprise.mail_contact.$model" type="email" id="intput-email" name="intput-mail"
                              placeholder="Email ..." :state="validateState('mail_contact')"></b-form-input>
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.mail_contact.required">Ce champ est obligatoire.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.mail_contact.minLength">Ce champ doit contenir au moins 5 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.mail_contact.maxLength">Ce champ doit contenir au moins 255 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.mail_contact.email">Ce champ doit être un email valide.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
            ...
            <b-col lg="4">
              <b-form-group id="intput-groupe-tel" label="Tél." description="Veuillez encoder le numéro de téléphone"
                ...
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tel.required">Ce champ est obligatoire.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tel.numeric">Ce champ doit être numérique.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tel.minLength">Ce champ doit contenir au moins 5 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero_tel.maxLength">Ce champ doit contenir au moins 255 caractères.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
            ...
            <b-col lg="4">
              <b-form-group id="intput-groupe-web" label="Site web" description="Veuillez encoder le site web"
                ...
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.site_web.required">Ce champ est obligatoire.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.site_web.url">Ce champ doit être un url valide.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
          </b-row>
            ...
            <b-col lg="8">
              <b-form-group id="intput-groupe-rue" label="Rue" description="Veuillez encoder la rue"
                ...
                <b-form-invalid-feedback>
                  ...
                  <b-badge pill variant="danger" v-if="!$v.entreprise.rue.minLength">Ce champ doit contenir au moins 2 caractères.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.rue.maxLength">Ce champ doit contenir au moins 255 caractères.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
            <b-col lg="4">
              <b-form-group id="input-groupe-numero" label="Numéro" description="Veuillez encoder le numéro"
                ...
                <b-form-invalid-feedback>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero.minLength">Ce champ doit contenir au moins 1 caractères.</b-badge><br>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero.alphaNum">Ce champ doit être numérique.</b-badge>
                  <b-badge pill variant="danger" v-if="!$v.entreprise.numero.required">Ce champ est obligatoire.</b-badge>
                </b-form-invalid-feedback>
              </b-form-group>
            </b-col>
          </b-row>
          ...
          <b-form-group label="Ville"
            ...
            <b-form-invalid-feedback>
              <b-badge pill variant="danger" v-if="!$v.entreprise.ref_ville.required">Ce champ est obligatoire.</b-badge>
            </b-form-invalid-feedback>
          </b-form-group>
